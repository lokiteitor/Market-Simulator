 ...
 * única):
 *
 *   1. el bloque `prices:` de `bots-v1/config.yaml`, `bots-v2/config.yaml`,
 *      `bots-ciudad/config.yaml` y `bots-hidro/config.yaml` (el mismo en los
 *      cuatro: si divergen, los dos enjambres, las ciudades y las centrales
