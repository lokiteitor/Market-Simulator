...
export const ErrorCodes = {
  ...
  unknown_installation_type: { status: 404, title: "Tipo de instalación desconocido" },
  installation_role_mismatch: { status: 403, title: "El tipo de instalación no corresponde al rol del agente" },
  installation_max_level: { status: 422, title: "Instalación en nivel máximo" },
  ttl_out_of_range: { status: 422, title: "TTL fuera de rango" },
  resource_depleted: { status: 422, title: "Recurso agotado (yacimiento en 0)" },
  bank_insufficient_gold: { status: 422, title: "El banco no tiene oro suficiente" },
  insufficient_gold_backing: { status: 422, title: "Emisión sin respaldo de oro suficiente" },
  conversion_below_minimum: { status: 422, title: "Conversión por debajo del mínimo (nocional 0)" },
  no_gold_standard: { status: 409, title: "La corrida no tiene patrón oro sembrado" },
