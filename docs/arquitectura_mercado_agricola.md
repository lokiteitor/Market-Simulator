...
- *Contexto:* en `bots-v1` la unidad de especialización es el **tipo de instalación** (`specialties.go`: cinco conjuntos que particionan los 17 tipos) y el reparto de la flota es round-robin entre las 6 estrategias (`strats[(i-1)%6]`). Dos consecuencias que ningún ajuste de parámetros corrige:
...
- *Consecuencias:*
  - (+) La cobertura del catálogo deja de ser un sorteo: por construcción ninguna de las 152 recetas se queda sin productores.
